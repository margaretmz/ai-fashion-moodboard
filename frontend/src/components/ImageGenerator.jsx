...
function ImageGenerator({ onImageGenerated, selectedModel, currentImage, includeReasoning, apiKey }) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const imageData = await generateImage(subject, selectedModel, includeReasoning, apiKey)
